...
export function createInstrumentSequence(buffer: AudioBuffer, time: number): InstrumentalSequence {
  return createAudioSequence<InstrumentTrackKind, BufferedAudioSequenceType, InstrumentalSequence>(
    bufferedAudioSequenceType,
    time,
    (base, dispatchEvent) => {
