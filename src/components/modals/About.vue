...
<template>
  <dialog ref="dialogRef" class="modal" @cancel.prevent="handleClose">
    <div class="bg-base-300 modal-box max-w-md xl:max-w-2xl">
      <!-- Identity header -->
      <div
        class="flex flex-col items-center text-center gap-3 pb-5 border-b border-base-content/10"
      >
        <div
        ...
        <div>
          ...
          <p class="text-base-content/40 text-xs mt-0.5">
            v{{ appVersion }} · early preview
          </p>
        </div>
        <p class="text-sm text-base-content/60 leading-relaxed max-w-xs">
          A free music studio that lives in your browser. Record, compose, and
          mix — no install, no account, just music.
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4 py-5">
        <div class="flex gap-3 items-start">
          <div
            class="shrink-0 w-8 h-8 rounded-lg bg-error/15 flex items-center justify-center"
          >
        ...
        <div class="flex gap-3 items-start">
          <div
            class="shrink-0 w-8 h-8 rounded-lg bg-secondary/15 flex items-center justify-center"
          >
            <i class="iconify mdi--piano text-secondary text-base" />
          </div>
          <div>
            <p class="text-sm font-semibold leading-tight">
              Compose with a piano roll
            </p>
            <p class="text-xs text-base-content/50 mt-0.5 leading-snug">
        ...
        <div class="flex gap-3 items-start">
          <div
            class="shrink-0 w-8 h-8 rounded-lg bg-warning/15 flex items-center justify-center"
          >
        ...
        <div class="flex gap-3 items-start">
          <div
            class="shrink-0 w-8 h-8 rounded-lg bg-success/15 flex items-center justify-center"
          >
      ...
      <!-- Footer -->
      <p
        class="text-xs text-base-content/30 text-center pt-3 border-t border-base-content/10"
      >
        Free &amp; open source ·
        <a
